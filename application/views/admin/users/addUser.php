        ...
        <div class="row add_post">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Enter Last Name" value=" " required  >
                    
                     
                </div>
                <div class="form-group">
                <label for="role">Role</label>
                    <select name="role" id="role" class="form-control form-control-user" value=" ">
